...
const (
	DamageCalcService_DamageCalc_FullMethodName = "/calc.v1.DamageCalcService/DamageCalc"
)
...
func (c *damageCalcServiceClient) DamageCalc(ctx context.Context, in *DamageCalcRequest, opts ...grpc.CallOption) (*DamageCalcResponse, error) {
	...
	err := c.cc.Invoke(ctx, DamageCalcService_DamageCalc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var DamageCalcService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "calc.v1.DamageCalcService",
	...
	Metadata: "calc/v1/attack_calc.proto",
}
